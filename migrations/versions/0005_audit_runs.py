...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("severity_high", sa.Integer, server_default="0", nullable=False),
        sa.Column("severity_medium", sa.Integer, server_default="0", nullable=False),
        sa.Column("severity_low", sa.Integer, server_default="0", nullable=False),
